  ...
  PAGINE: {
    ...
    lavanderia: {
      ...
      blocchi: [
        ...
        { kv: [
            ...
            ["2. Aggiungere il detersivo", "nel cassetto della lavatrice", "detersivo"],
            ["3. Selezionare il servizio 2", "sul pannello di controllo a muro", "pulsantiera"],
            ["4. Inserire le monete", "RAPIDO 30: 2 gettoni da 2\u20ac \u00b7 INTENSIVO 60: 3 gettoni da 2\u20ac", "moneta"],
            ["Attenzione", "dopo pochi secondi la luce rossa sul servizio selezionato indica l\u2019inizio dell\u2019erogazione", "luce"],
            ["5. Premere il pulsante di accensione", "sulla lavatrice", "pulsanteOn"],
            ["6. Selezionare il ciclo desiderato", "con la manopola dei programmi", "manopola"],
          ...
          kv_en: [
            ...
            ["2. Add soap", "in the washing machine drawer", "detersivo"],
            ["3. Select service 2", "on the control panel on the wall", "pulsantiera"],
            ["4. Insert coins according to the wished cycle", "QUICK 30: 2 coins of \u20ac2 \u00b7 INTENSIVE 60: 3 coins of \u20ac2", "moneta"],
            ["Note", "after a few seconds a red light on the selected service will turn on and service supply will start", "luce"],
            ["5. Push the turn-on button", "on the washing machine", "pulsanteOn"],
            ["6. Select the wished cycle", "with the programme knob", "manopola"],
    ...
    salute: {
      ...
      blocchi: [
        ...
        { card: { nome: "Guardia Medica Turistica — Marina di Camerota", lat: 40.000847, lng: 15.376499,
        ...
        { card: { nome: "Farmacia Speranza", cat: "farmacia", pin: "farmacia", lat: 40.035865, lng: 15.286794,
          dove: "Corso Carlo Pisacane 64 — Palinuro centro",
          testo: "La farmacia di Palinuro. Telefono 0974 931315." } },
        { card: { nome: "Dispensario stagionale Farmacia Speranza", cat: "farmacia", pin: "farmacia", lat: 40.043285, lng: 15.300119,
        ...
        { card: { nome: "Farmacia San Pantaleone", cat: "farmacia", pin: "farmacia", lat: 40.064913, lng: 15.312591,
          dove: "Via T. Tasso 27 — Centola paese", testo: "" } },
        { card: { nome: "Farmacia Giuliani", cat: "farmacia", pin: "farmacia", lat: 39.998588, lng: 15.370933,
          dove: "Marina di Camerota", testo: "" } },
        { card: { nome: "Farmacia Dott.ssa Di Maio", cat: "farmacia", pin: "farmacia", lat: 40.083850, lng: 15.265726,
