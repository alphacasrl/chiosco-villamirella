...
window.GUIDA = {
  ...
  MATTONELLE: [
    ...
    { id: "grotte",      nome: "Grotte",            icona: "grotte",      colore: "#7057c9", sezione: "cat:grotte" },
  ...
  PAGINE: {
    ...
    salute: {
      ...
      blocchi: [
        ...
        { t: "Guardia medica" },
        { card: { nome: "Guardia Medica Turistica — Marina di Camerota", lat: 39.999924, lng: 15.376212,
        ...
        { p: "A Palinuro non ci sono più guardia medica né pronto soccorso: è presente solo una postazione ambulanza del 118, che NON può ricevere persone che si presentano di persona. In caso di emergenza chiama il 118." },
        { t: "Farmacie" },
        ...
        { card: { nome: "Farmacia di Centola", lat: 40.064913, lng: 15.312591,
          dove: "Centola paese", testo: "" } },
