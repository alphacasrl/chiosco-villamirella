...
window.GUIDA = {
  ...
  PAGINE: {
    ...
    servizi: {
      ...
      mappa: true,
      blocchi: [
        { t: "Benzinai", t_en: "Petrol stations", icona: "benzina" },
        { card: { nome: "Api-Ip — Camerota", icona: "benzina", pin: "benzina", lat: 40.054963, lng: 15.3598, dove: "Camerota", dove_en: "Camerota", testo: "" } },
        { card: { nome: "Carburanti Magliano — Marina di Camerota", icona: "benzina", pin: "benzina", lat: 40.000104, lng: 15.373979, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { card: { nome: "Q8 — Marina di Camerota", icona: "benzina", pin: "benzina", lat: 40.002815, lng: 15.364698, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { card: { nome: "IP — Palinuro", icona: "benzina", pin: "benzina", lat: 40.039248, lng: 15.31085, dove: "Palinuro", dove_en: "Palinuro", testo: "" } },
        { card: { nome: "IP — Palinuro", icona: "benzina", pin: "benzina", lat: 40.044234, lng: 15.287993, dove: "Palinuro", dove_en: "Palinuro", testo: "" } },
        { card: { nome: "Esso — Palinuro", icona: "benzina", pin: "benzina", lat: 40.036723, lng: 15.286484, dove: "Palinuro", dove_en: "Palinuro", testo: "" } },
        { card: { nome: "IP — Palinuro", icona: "benzina", pin: "benzina", lat: 40.042715, lng: 15.29071, dove: "Palinuro", dove_en: "Palinuro", testo: "" } },
        { card: { nome: "Q8 — San Severino", icona: "benzina", pin: "benzina", lat: 40.094303, lng: 15.358814, dove: "San Severino · Strada Provinciale 17bis Valle Mingardo", dove_en: "San Severino · Strada Provinciale 17bis Valle Mingardo", testo: "" } },
        { card: { nome: "Benzinaio — San Severino", icona: "benzina", pin: "benzina", lat: 40.092156, lng: 15.324063, dove: "San Severino", dove_en: "San Severino", testo: "" } },
        { t: "Uffici postali", t_en: "Post offices", icona: "posta" },
        { card: { nome: "Poste Italiane", icona: "posta", pin: "posta", lat: 40.089877, lng: 15.282128, dove: "Caprioli · SR447/b", dove_en: "Caprioli · SR447/b", testo: "" } },
        { card: { nome: "Ufficio postale — Centola", icona: "posta", pin: "posta", lat: 40.065239, lng: 15.312416, dove: "Centola", dove_en: "Centola", testo: "" } },
        { card: { nome: "Ufficio postale — Lentiscosa", icona: "posta", pin: "posta", lat: 40.021023, lng: 15.385166, dove: "Lentiscosa · Via Trento 2", dove_en: "Lentiscosa · Via Trento 2", testo: "" } },
        { card: { nome: "Marina di Camerota", icona: "posta", pin: "posta", lat: 40.000843, lng: 15.374869, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { card: { nome: "Ufficio postale — Palinuro", icona: "posta", pin: "posta", lat: 40.038275, lng: 15.287669, dove: "Palinuro", dove_en: "Palinuro", testo: "" } },
        { card: { nome: "Poste Italiane", icona: "posta", pin: "posta", lat: 40.102007, lng: 15.22819, dove: "Pisciotta · Via Cristoforo Colombo 2", dove_en: "Pisciotta · Via Cristoforo Colombo 2", testo: "" } },
        { card: { nome: "Poste Italiane", icona: "posta", pin: "posta", lat: 40.110556, lng: 15.233446, dove: "Pisciotta", dove_en: "Pisciotta", testo: "" } },
        { card: { nome: "Ufficio postale Poderia", icona: "posta", pin: "posta", lat: 40.094781, lng: 15.38559, dove: "Poderia", dove_en: "Poderia", testo: "" } },
        { t: "Banche", t_en: "Banks", icona: "banca" },
        { card: { nome: "Intesa Sanpaolo", icona: "banca", pin: "banca", lat: 40.00037, lng: 15.371071, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { card: { nome: "Banca del Cilento e Luceania Sud", icona: "banca", pin: "banca", lat: 40.000096, lng: 15.373219, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { card: { nome: "Intesa Sanpaolo", icona: "banca", pin: "banca", lat: 40.001331, lng: 15.376514, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { card: { nome: "Banca della Campania", icona: "banca", pin: "banca", lat: 40.038811, lng: 15.28923, dove: "Palinuro", dove_en: "Palinuro", testo: "" } },
        { card: { nome: "Intesa Sanpaolo", icona: "banca", pin: "banca", lat: 40.033127, lng: 15.28691, dove: "Palinuro · Corso Carlo Pisacane 23", dove_en: "Palinuro · Corso Carlo Pisacane 23", testo: "" } },
        { card: { nome: "Bancomat — Marina di Camerota", icona: "banca", pin: "banca", lat: 40.002431, lng: 15.361251, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { card: { nome: "Bancomat — Palinuro", icona: "banca", pin: "banca", lat: 40.039275, lng: 15.311026, dove: "Palinuro", dove_en: "Palinuro", testo: "" } },
        { card: { nome: "Bancomat — Pisciotta", icona: "banca", pin: "banca", lat: 40.110543, lng: 15.233397, dove: "Pisciotta", dove_en: "Pisciotta", testo: "" } },
        { card: { nome: "Bancomat — Pisciotta", icona: "banca", pin: "banca", lat: 40.1092, lng: 15.235012, dove: "Pisciotta", dove_en: "Pisciotta", testo: "" } },
        { t: "Tabaccherie", t_en: "Tobacconists", icona: "tabacchi" },
        { card: { nome: "Tabaccheria — Lentiscosa", icona: "tabacchi", pin: "tabacchi", lat: 40.019672, lng: 15.386731, dove: "Lentiscosa", dove_en: "Lentiscosa", testo: "" } },
        { card: { nome: "Tabaccheria — Marina di Camerota", icona: "tabacchi", pin: "tabacchi", lat: 40.000354, lng: 15.373036, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { card: { nome: "Tabaccheria — Marina di Camerota", icona: "tabacchi", pin: "tabacchi", lat: 39.99799, lng: 15.371414, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { t: "Edicole", t_en: "Newsagents", icona: "edicola" },
        { card: { nome: "Edicola — Marina di Camerota", icona: "edicola", pin: "edicola", lat: 39.998195, lng: 15.371056, dove: "Marina di Camerota", dove_en: "Marina di Camerota", testo: "" } },
        { p: "Dati da OpenStreetMap: orari e aperture possono variare, in caso di dubbio chiedi in reception.",
          p_en: "Data from OpenStreetMap: opening hours may vary, ask at reception if in doubt." }
      ]
    },
