...
window.LUOGHI = [
  ...
  {
    id: "chiesa-palinuro",
    nome: "Chiesa di Palinuro",
    categoria: "santuari",
    lat: 40.034602,   lng: 15.287262,   verified: true,
    notaCoordinate: "APPROSSIMATA al centro di Palinuro: la parrocchiale non e' mappata su OpenStreetMap — sposta il pin sull'ingresso esatto",
    sommario: "",
    immagine: "",
    articoli: [],
    distanzaKm: "",   tempoAuto: "",
